...
CantBit= 25;                   %Cantidad de bits por rama
CantSimbOFDM=CantBit/3;       %Cantidad de simbolos OFDM
Rb1=25;                     %Tasa de bit de la primera fuente 
Rb2=25;                     %Tasa de bit de la segunda fuente
Rb3=25;                     %Tasa de bit de la penultima fuente
Rb4=25;                     %Tasa de bit de la ultima fuente
...
Tc= 6.666666666666e-04;
cantchip_simbolo = Tb1/Tc;
Multicamino = [2*Tc, 7*Tc, 15*Tc];
Ganancia = [-1, -2, -3];
Gain1 = 10^(Ganancia(1)/20);
Gain2 = 10^(Ganancia(2)/20);
Gain3 = 10^(Ganancia(3)/20);
%--------------------------------------------------------------------------------------------
Trama=[Tb1,Tb2,Tb3,Tb4];
Rrama=[Rb1,Rb2,Rb3,Rb4];
TransfBitPerSimb=[1,1,1,1];
Fp=1*10^6;                                %Frecuencia portadora - No esta implementado
...
Ts3=Tb3;                  %Tasa de simbolo BPSK
Ts4=Tb4;                  %Tasa de simbolo BPSK
%---------------------------------------------------------------------------------------------
